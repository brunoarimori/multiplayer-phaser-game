 ...
 * If the user summons:
 *
 *   `io('http://http://localhost/a');`
 *   `io('http://http://localhost/b');`
 *
...
function url(uri, loc){
  ...
  // make sure we treat `http://localhost:80` and `http://localhost` equally
  if (!obj.port) {
...
function Socket(uri, opts){
  ...
  this.hostname = opts.hostname ||
    (global.location ? location.hostname : 'http://localhost');
